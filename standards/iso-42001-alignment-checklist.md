...
Because of this shared structure, an organization that already runs an ISO 27001 or ISO 9001 management system does not need to build a parallel governance apparatus for AI. It can extend its existing management system with AI-specific clauses and Annex A controls — the approach most enterprise adopters take in practice.
