...
> **CHAPTER PURPOSE** Select and balance AI opportunities across assist, enhance, reconfigure and transform horizons using value, feasibility, risk and foundational readiness.

## Opportunity framing

An opportunity is expressed as an outcome hypothesis: for a defined population and workflow, a specified intelligence capability is expected to change a measurable outcome within stated guardrails. This framing prevents use-case lists from becoming disconnected collections of features.
...
A healthy portfolio mixes quick H1/H2 improvements with a smaller number of H3/H4 transformations, includes both business outcomes and shared foundations, and avoids excessive concentration in one vendor, model, data source or regulatory risk. Dependencies are explicit: a shared customer identity service, document ingestion pipeline or evaluation platform may unlock several deployments and should be funded as a portfolio capability rather than hidden inside one project.
