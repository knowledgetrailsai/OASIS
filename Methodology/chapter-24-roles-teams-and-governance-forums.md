...
Small organizations may combine several roles in one person, but accountability must remain explicit. A person who builds a control may self-test it for low-risk work; high-impact systems should add independent challenge. Outcome ownership must remain with the business authority capable of changing the process and accepting consequences.
