...
OASIS treats adoption as workflow engineering, not post-build communication. The target is a redesigned operating system in which human judgment, AI capability, deterministic controls and enterprise systems each perform the work for which they are best suited.
...
The objective is appropriate reliance—not maximum trust. Interfaces should reveal source quality, uncertainty, limitations, action scope and the consequence of approval. Users need easy correction and escalation. Performance should be measured for over-reliance, under-use, rubber-stamping, automation bias and workload shifted into exception handling.

## Change and capability

- Engage users during discovery and evaluation, not only training.

- Redesign roles, capacity, incentives, quality checks and performance measures.

- Teach purpose, limits, evidence interpretation, approvals, incident reporting and data responsibilities.

- Support accessibility, language, channel and digital-literacy needs.

- Measure time-to-proficiency, correct use, overrides, workarounds and perceived control.
