...
The primary outcome is supported by leading indicators and constrained by guardrails. Operational and intelligence measures explain why the outcome moved. Every metric has an owner, definition, source, cadence, target, segmentation and action threshold. Automation that shifts cost, risk or workload elsewhere is not counted as value.

## Outcome reporting cadence

- Daily or weekly operational review for incidents, quality shifts and exceptions.

- Monthly outcome review joining business, user, intelligence, risk, service and cost evidence.

- Quarterly portfolio review for investment, dependencies, reuse, scale and retirement.

- Event-driven review for material model, provider, data, jurisdiction, purpose or autonomy change.

## Evidence-based continuation

The dashboard supports four kinds of decision: continue because value and controls are stable; correct because the outcome is viable but performance has degraded; re-scope because the causal mechanism or boundary is wrong; or stop because sustained value, safety or economics are not supported.
