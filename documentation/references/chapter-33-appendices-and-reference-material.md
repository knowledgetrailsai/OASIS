...
> **CHAPTER PURPOSE** Consolidate the glossary, artifact catalogue, gate catalogue, metrics, risks, design patterns, maturity model and framework references.
...
Artifacts are grouped into outcome and portfolio, workflow and experience, intelligence and data, architecture and integration, evaluation and assurance, operations and scaling. The authoritative list is the template toolkit in Chapter 32; local methods may rename or combine artifacts while preserving their decision purpose.
...
OASIS is an original methodology. The following sources inform or complement its risk, management, engineering and agent practices. They should be used in their current official form and interpreted for the organization’s jurisdiction and role.
