...
> **CHAPTER PURPOSE** Define how enterprise leadership, business domains, platform teams, governance functions, forward-deployed pods and service operations share accountability.
...
OASIS separates outcome ownership, technical service ownership, model or platform stewardship and risk acceptance. No model owner may implicitly become the owner of a consequential business decision. Authority is assigned to roles and case classes, not inferred from system capability.
...
Funding evolves across horizons: discovery funding tests uncertainty; production funding creates the service; run funding sustains outcomes; and platform funding productizes repeated capability. Continuation is tied to evidence and learning, not sunk-cost protection. Shared services should have transparent allocation logic so local deployments can compare reuse against bespoke alternatives.
