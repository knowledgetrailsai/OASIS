...
Artifact depth should match the decision's consequence, not the other way around. A single-team productivity tool needs a lighter Value and Risk Case than a system influencing customers' money, health or legal standing. What should never be tailored away is a real commitment from someone with authority to own the outcome.
