...
| OWASP Top 10 for LLM and GenAI Applications | Application-security risk framework | Directly informs agent, prompt, retrieval, tool and output-layer threat models. Operationalized in the [Security: Agentic AI Threat Model and Control Checklist](../security/agentic-ai-threat-and-control-checklist.md). | The system uses LLMs, RAG, tools, plugins, agents, or autonomous workflows. |
