...
**Known gap:** Chapter 17 has no repository at Forge/Loom/Verity's depth. Helm's tool-contract principles are sound as far as they go but do not yet cover a full pattern catalogue across enterprise system types (CRM, ERP, ticketing, and similar). For the data and knowledge-service side of an integration, see [Forge](https://github.com/knowledgetrailsai/Forge), especially its [knowledge-service lifecycle](https://github.com/knowledgetrailsai/Forge/blob/master/02-knowledge-service-lifecycle/lifecycle-overview.md) and [structured-data retrieval](https://github.com/knowledgetrailsai/Forge/tree/master/09-structured-data-retrieval) material; for the authority, handoff, and process-placement side, see [Loom](https://github.com/knowledgetrailsai/Loom), especially its [Human–AI Workflow Blueprint](https://github.com/knowledgetrailsai/Loom/blob/master/02-workflow-blueprint/blueprint-overview.md) and [Process-to-Agent Participation Map](https://github.com/knowledgetrailsai/Loom/blob/master/05-process-architecture-integration/process-to-agent-participation-map.md). Forge and Loom are adjacent coverage, not dedicated Chapter 17 companions.
